...
# Try to import plotly, but make it optional (not installed on Render free tier to save memory)
try:
    ...
    # Charts use matplotlib/seaborn; plotly is optional. No need to warn.
